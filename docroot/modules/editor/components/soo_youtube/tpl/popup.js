...
function insertSooCom(i, j) {
	...
	var text = "<blockquote style=\"margin:0px; padding:0px;\" cite=\""+item[i][10]+"\">";
	if(j != 1) {
		if(fo.size_select) {
...
function preview_video(i) {
	...
	if(item[i][2]) {
		...
		html += '<option value="240">240x205</option><option value="320">320x265</option><option value="425">425x344</option><option value="480">480x385</option><option value="640" selected="selected">640x505</option>';
		html += '</select>';
