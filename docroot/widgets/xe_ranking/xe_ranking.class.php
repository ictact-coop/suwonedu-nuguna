<?php
    ...
    class xe_ranking extends WidgetHandler {
        ...
        function proc($args) {
            ...
            // Get module information after listing module_srls if the module is not RSS
                ...
                if(!$args->module_srls){
                    ...
                    $output = executeQueryArray('widgets.xe_ranking.getMids', $obj);
                    if($output->data) {
        ...
        /**
         * @brief Get a list of comments and return xe_rankingItem
         **/
        function _getCommentItems($args) {
            ...
            foreach($output as $key => $oComment) {
                ...
                $content_item = new xe_rankingItem($browser_title);
        ...
        function _getDocumentItems($args){
            ...
            // Get categories
            $obj->module_srl = $args->module_srl;
            $output = executeQueryArray('widgets.xe_ranking.getCategories',$obj);
			...
			if($args->list_type == 'ranking' && $args->ranking_extraction_method != 'A') {
				...
				$output = executeQueryArray('widgets.xe_ranking.getRankingDocuments', $obj);
			} else {
				$output = executeQueryArray('widgets.xe_ranking.getNewestDocuments', $obj);
			}
            ...
            if(count($output->data)) {
                ...
                for($i=0,$c=count($document_srls);$i<$c;$i++) {
                    ...
                    $content_item = new xe_rankingItem( $args->module_srls_info[$module_srl]->browser_title );
       ...
       /**
        ...
        function _getRssItems($args){
            ...
            if($xml_doc->rss) {
                ...
                foreach ($items as $key => $value) {
                    ...
                    $content_item = new xe_rankingItem($rss->title);
        ...
        function _compile($args,$content_items){
			...
			if($args->list_type == 'ranking') {
				...
				//$widget_info->rangking_name = 'xe_rankingRanking_'.rand(100000,500000).rand(100000,500000);
				...
				//$widget_info->content_sliding_normal_name = 'xe_rankingSlidingNormal_'.rand(100000,500000).rand(100000,500000);
			} else if($args->list_type == 'image_title') {
				//$widget_info->content_sliding_image_title_name = 'xe_rankingSlidingImageTitle_'.rand(100000,500000).rand(100000,500000);
			}
    ...
    class xe_rankingItem extends Object {
        ...
        function xe_rankingItem($browser_title=''){
