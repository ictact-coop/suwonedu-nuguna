	...
	$.fn.gyContentRanking=function(options){  
		...
		return this.each(function() {
			...
			var init = function() {
				...
				if(parseInt(options.ranking_width) < 100+'%') options.ranking_width = 100+'%';
				_this.css('width', options.ranking_width+'%');
				...
				_this_li.find('.rank_text').css('width', rank_text_width+'%');
			...
			var animateRankBlock = function(){
				...
				obj.children('div').eq(1).find('.rank_text').css('color', '#'+options.rolling_text_color).css('width', rank_text_width+'%');
				...
				function() {
						...
						_this_li.eq(play_num).children('div').eq(0).find('.rank_text').css('color', '#'+options.title_text_color).css('width', rank_text_width+'%'); //.css('background', '#cccccc')
